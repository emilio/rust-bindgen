...
impl jsval_layout__bindgen_ty_1 {
    ...
    pub fn payload47(&self) -> u64 {
        unsafe {
            ::std::mem::transmute(((self._bitfield_1 &
                                        (140737488355327u64 as u64)) >> 0u32)
                                      as u64)
        }
    }
    #[inline]
    pub fn set_payload47(&mut self, val: u64) {
        self._bitfield_1 &= !(140737488355327u64 as u64);
        self._bitfield_1 |=
            ((val as u64 as u64) << 0u32) & (140737488355327u64 as u64);
    }
    #[inline]
    ...
    pub fn set_tag(&mut self, val: JSValueTag) {
        self._bitfield_1 &= !(18446603336221196288u64 as u64);
        self._bitfield_1 |=
            ((val as u32 as u64) << 47u32) & (18446603336221196288u64 as u64);
    }
}
#[repr(C)]
#[derive(Debug, Copy)]
