...
pub trait ClangItemParser: Sized {
    ...
    fn named_type<S>(name: S, parent: ItemId, context: &mut BindgenContext) -> ItemId
        where S: Into<String>;
    fn named_type_with_id<S>(id: ItemId, name: S, parent: ItemId, context: &mut BindgenContext) -> ItemId
        where S: Into<String>;
